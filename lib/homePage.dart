...
class _HomePageState extends State<HomePage> {
  ...
  Widget _volume() {
    return Slider(
        ...
        onChanged: (newVolume) {
          ...
          content: const Text('Please decrease the volume to get better experience'),
  ...
  Widget _pitch() {
    return Slider(
      ...
      onChanged: (newPitch) {
        final snackBar = SnackBar(
          content: const Text('Please decrease the pitch to get better experience'),
          backgroundColor: (Colors.green),
        );
  ...
  Widget _rate() {
    return Slider(
      ...
      onChanged: (newRate) {
         final snackBar = SnackBar(
          content: const Text('speed of the voice with set accordingly...'),
          backgroundColor: (Colors.green),
        );
